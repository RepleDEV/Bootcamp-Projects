    ...
    <?php 
        ...
        */
        ...
        for ($i = 0;$i < count($items);$i++) {
            $item = $items[$i];
            array_push($asc_arr, array());
            array_push($asc_arr[$i], "id",$item[0]);
            array_push($asc_arr[$i], "name",$item[1]);
            array_push($asc_arr[$i], "price",$item[2]);
            array_push($asc_arr[$i], "desc",$item[3]);
            array_push($asc_arr[$i], "src",$item[4]);
        }

        foreach ($asc_arr as $x) {
            print_r($x);
            echo "<p>";
        }
